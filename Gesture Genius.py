...
imgb=PhotoImage(file="product2 (1).png")
i=Label(image=imgb,height=500,width=925)
...
s=Button(gui,text="START",width=10,bg="white",font='garamond',command=start)
s.place(x=200,y=100)

#Config elements for Exit button       
exit_button = Button(gui, text="EXIT",width=10,bg="white",font='garamond',fg="black", command=end)
